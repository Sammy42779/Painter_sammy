...
DST_DIR="/hhd3/ld/data/nyu_depth_v2/reimp_${ATTACK}${STEP}_${EPSILON}/${CHANGE}/${ATTACK_ID}/"
SAVE_DATA_PATH="/hhd3/ld/data/Painter_root/nyu_depth/reimp_${ATTACK}${STEP}_${EPSILON}/${CHANGE}/${ATTACK_ID}/"

# inference
CUDA_VISIBLE_DEVICES=3 python eval/nyuv2_depth/painter_inference_depth_attack_with_clip_changeB.py \
  --ckpt_path /hhd3/ld/checkpoint/ckpt_Painter/painter_vit_large.pth \
  --model ${MODEL} \
  --prompt ${PROMPT} \
  --attack_id ${ATTACK_ID} \
...
########### bash eval/nyuv2_depth/eval_sammy_attack_with_clip_changeB_pgd_attackAB.sh 