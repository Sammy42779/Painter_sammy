...
if __name__ == '__main__':
    ...
    ## 108: /data1/; 110: /hhd3/
    dst_dir = os.path.join(f'/hhd3/ld/data/nyu_depth_v2/our_attack/{args.attack_method}_{args.num_steps}/'
    ...
    save_data_path = f'/hhd3/ld/data/Painter_root/nyu_depth/our_attack_analysis/{args.attack_method}/{args.attack_id}_{args.epsilon}/'
