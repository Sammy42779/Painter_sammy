...
DST_DIR="/hhd3/ld/data/nyu_depth_v2/nyuv2_depth_inference_${CKPT_FILE}_${PROMPT}"

# inference
CUDA_VISIBLE_DEVICES=0 python eval/nyuv2_depth/painter_inference_depth.py \
  --ckpt_path /hhd3/ld/checkpoint/ckpt_Painter/painter_vit_large.pth \
  --model ${MODEL} \
  --prompt ${PROMPT}
