...
from attack_utils_baseline import *
...
def get_args_parser():
    ...
    parser.add_argument('--dst_dir', type=str, default='debug_dir')
    parser.add_argument('--save_data_path', type=str, default='debug_data')
...
if __name__ == '__main__':
    ...
    # img2_path = "/hhd3/ld/data/nyu_depth_v2/sync/{}.jpg".format(args.prompt)   ## prompt A图
    img2_path = random.choice(COCO_LIST_B)    # 修改A图为其他OOD图片
    tgt_path = "/hhd3/ld/data/nyu_depth_v2/sync/{}.png".format(args.prompt.replace('rgb', 'sync_depth'))  ## prompt gt
    tgt2_path = tgt_path
    ...
    for img_path in tqdm.tqdm(img_path_list):
        ...
        adv_img, adv_tgt = get_adv_img_adv_tgt_baseline(img, tgt, model_painter, device, args.attack_id, args.attack_method, epsilon=args.epsilon, num_steps=args.num_steps)
        if i <= 67:
