...
if __name__ == '__main__':
    ...
    dst_dir = os.path.join(f'/hhd3/ld/data/light_enhance/output_attack_vis/{args.attack_method}/'
    ...
    save_data_path = f'/hhd3/ld/data/Painter_root/lol_enhance/adv_data_B/{args.attack_method}_{args.epsilon}/'
