...
from attack_utils_ours_breakAC_with_B import *
...
if __name__ == '__main__':
    ...
    for img_path in tqdm.tqdm(img_path_list):
        ...
        adv_img, adv_tgt = get_adv_img_adv_tgt_ours_breakAC_with_B(img, tgt, model_painter, device, args.attack_id, args.attack_method, epsilon=args.epsilon, num_steps=args.num_steps)
