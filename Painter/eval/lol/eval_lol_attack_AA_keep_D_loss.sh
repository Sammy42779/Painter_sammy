...
do
    for EXP_ID in attack_ABC # attack_C attack_AB attack_AC 
    do
        for LAM_AB in 0.01 # 0.1 0.001
        do 

        OUT_PATH="/hhd3/ld/painter_sammy_output/${TASK}/${EXP}/${ATTACK_METHOD}_eps${EPSILON}_steps${STEPS}/keep_D_loss/mask_ratio_${MASK_RATIO}/lamAB_${LAM_AB}/${EXP_ID}"
