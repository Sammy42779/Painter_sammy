...
# inference
CUDA_VISIBLE_DEVICES=1,2,3,8 python -m torch.distributed.launch --nproc_per_node=${NUM_GPUS} --master_port=1999 --use_env \
...
# bash eval/ade20k_semantic/eval_sammy_attack_with_clip_changeB.sh