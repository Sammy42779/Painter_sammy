...
DST_DIR="/hhd3/ld/data/ade20k/gt_exp/reimp_${ATTACK}${STEP}_${EPSILON}1/${ATTACK_ID}/"
SAVE_DATA_PATH="/hhd3/ld/data/Painter_root/ade20k_semantic/gt_exp/reimp_${ATTACK}${STEP}_${EPSILON}1/${ATTACK_ID}/"

# inference
CUDA_VISIBLE_DEVICES=4,5,6,7 python -m torch.distributed.launch --nproc_per_node=${NUM_GPUS} --master_port=1999 --use_env \
...
# bash eval/ade20k_semantic/eval_sammy_attack_with_clip_pgd_gt_attackBC.sh