...
DST_DIR="/hhd3/ld/data/ade20k/reimp_${ATTACK}${STEP}_${EPSILON}/changeB/${ATTACK_ID}/"
SAVE_DATA_PATH="/hhd3/ld/data/Painter_root/ade20k_semantic/reimp_${ATTACK}${STEP}_${EPSILON}/changeB/${ATTACK_ID}/"


# inference
# CUDA_VISIBLE_DEVICES=6 python -m torch.distributed.launch --nproc_per_node=${NUM_GPUS} --master_port=1989 --use_env \
...
# bash eval/ade20k_semantic/eval_sammy_attack_with_clip_changeB_pgd.sh