...
# inference
CUDA_VISIBLE_DEVICES=0,1,2,3,4,6,8 python -m torch.distributed.launch --nproc_per_node=${NUM_GPUS} --master_port=2000 --use_env \
...
# bash eval/ade20k_semantic/eval_sammy_attack_with_clip.sh