...
DST_DIR="/hhd3/ld/data/ade20k/gt_exp/reimp_${ATTACK}${STEP}_${EPSILON}/${ATTACK_ID}/"
SAVE_DATA_PATH="/hhd3/ld/data/Painter_root/ade20k_semantic/gt_exp/reimp_${ATTACK}${STEP}_${EPSILON}/${ATTACK_ID}/"

# inference
CUDA_VISIBLE_DEVICES=1,3 python -m torch.distributed.launch --nproc_per_node=${NUM_GPUS} --master_port=1992 --use_env \
  eval/ade20k_semantic/painter_inference_segm_attack_with_clip_gt.py \
...
CUDA_VISIBLE_DEVICES=1 python eval/ade20k_semantic/ADE20kSemSegEvaluatorCustom.py \
  --pred_dir ${DST_DIR}



# bash eval/ade20k_semantic/eval_sammy_attack_with_clip_pgd_gt_attackAC.sh