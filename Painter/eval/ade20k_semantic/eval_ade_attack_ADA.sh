...
do
    ...
    do
        ...
        do 
            ...
            NUM_GPUS=4
            PORT=29504
            CUDA_VISIBLE_DEVICES=4,5,6,8 python -m torch.distributed.launch --nproc_per_node=${NUM_GPUS} --master_port=${PORT} --use_env \
...
do
    ...
    do
        ...
        do 
            ...
            CUDA_VISIBLE_DEVICES=8 python ADE20kSemSegEvaluatorCustom.py \
                --pred_dir ${DST_DIR}
            done
        done 
    done 
