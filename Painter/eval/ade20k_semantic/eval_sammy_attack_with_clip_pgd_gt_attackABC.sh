...
# inference
CUDA_VISIBLE_DEVICES=0,1,3,5 python -m torch.distributed.launch --nproc_per_node=${NUM_GPUS} --master_port=1993 --use_env \
...
# bash eval/ade20k_semantic/eval_sammy_attack_with_clip_pgd_gt_attackABC.sh