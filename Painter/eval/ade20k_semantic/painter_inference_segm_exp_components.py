...
if __name__ == '__main__':
    ...
    修改prompt, 即 A B 图
    """
    img2, tgt2 = get_prompt_gt(img2_path, tgt2_path, input_size, args.exp_id, args.transfer_img)
    ...
    for data in tqdm.tqdm(data_loader_val):
        ...
        if i <= 2:
            np.save(f'/hhd3/ld/data/Painter_root/ade20k_semantic/save_data/img2_prompt_{args.exp_id}_{i}.npy', img)
            np.save(f'/hhd3/ld/data/Painter_root/ade20k_semantic/save_data/tgt2_prompt_{args.exp_id}_{i}.npy', tgt)
        i += 1
