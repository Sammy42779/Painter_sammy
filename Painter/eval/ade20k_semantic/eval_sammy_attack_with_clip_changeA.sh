...
# inference
CUDA_VISIBLE_DEVICES=8 python -m torch.distributed.launch --nproc_per_node=${NUM_GPUS} --master_port=2000 --use_env \
...
CUDA_VISIBLE_DEVICES=8 python eval/ade20k_semantic/ADE20kSemSegEvaluatorCustom.py \
  --pred_dir ${DST_DIR}



# bash eval/ade20k_semantic/eval_sammy_attack_with_clip_changeA.sh