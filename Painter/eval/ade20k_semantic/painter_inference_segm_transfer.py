...
def get_args_parser():
    ...
    parser.add_argument('--supp', action='store_true', default=False)
    parser.add_argument('--supp_id', type=str, default='None', help='Demonstration for attack')
...
if __name__ == '__main__':
    ...
    # if args.supp:
    #     print(f'---supp_id:{args.supp_id}---')
    #     img2, tgt2 = get_prompt_gt(img2_path, tgt2_path, args.input_size, 
    #                                args.supp_id, args.style_change_A, args.style_change_B, task=args.task)

    if args.exp == 'Attack_VA':
        print('Attack_VA')
        img2 = np.load(f'/hhd3/ld/painter_sammy_output/transfer_data/{args.task}/{args.exp}/{args.exp_id}/PGD_eps2_steps10/save_data/img2_prompt_adv.npy')
        tgt2 = np.load(f'/hhd3/ld/painter_sammy_output/transfer_data/{args.task}/{args.exp}/{args.exp_id}/PGD_eps2_steps10/save_data/tgt2_prompt_adv.npy')
    elif args.exp == 'Attack_ADA':
        print('Attack_ADA')
        if args.exp_id == 'attack_AB':
            img2 = np.load(f'/hhd3/ld/painter_sammy_output/transfer_data/{args.task}/{args.exp}/PGD_eps2_steps10/keep_D_loss/mask_ratio_0.5/lamAB_0.1/lamAC_0.1/{args.exp_id}/save_data/img2_prompt_adv.npy')
            tgt2 = np.load(f'/hhd3/ld/painter_sammy_output/transfer_data/{args.task}/{args.exp}/PGD_eps2_steps10/keep_D_loss/mask_ratio_0.5/lamAB_0.1/lamAC_0.1/{args.exp_id}/save_data/tgt2_prompt_adv.npy')
        if args.exp_id == 'attack_ABC':
            img2 = np.load(f'/hhd3/ld/painter_sammy_output/transfer_data/{args.task}/{args.exp}/PGD_eps2_steps10/keep_D_loss/mask_ratio_0.25/lamAB_0.1/lamAC_0.1/{args.exp_id}/save_data/img2_prompt_adv.npy')
            tgt2 = np.load(f'/hhd3/ld/painter_sammy_output/transfer_data/{args.task}/{args.exp}/PGD_eps2_steps10/keep_D_loss/mask_ratio_0.25/lamAB_0.1/lamAC_0.1/{args.exp_id}/save_data/tgt2_prompt_adv.npy')

    img2 = img2[:input_size,:,:]
    tgt2 = tgt2[:input_size,:,:]
