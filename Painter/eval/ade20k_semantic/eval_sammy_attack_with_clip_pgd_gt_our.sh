...
# inference
CUDA_VISIBLE_DEVICES=0,2 python -m torch.distributed.launch --nproc_per_node=${NUM_GPUS} --master_port=1999 --use_env \
  eval/ade20k_semantic/painter_inference_segm_attack_with_clip_gt_our.py \
...
# bash eval/ade20k_semantic/eval_sammy_attack_with_clip_pgd_gt_our.sh