...
if __name__ == '__main__':
    ...
    dst_dir = os.path.join(f'/hhd3/ld/data/ade20k/our_attack/{args.attack_method}_{args.num_steps}/'
    ...
    save_data_path = f'/hhd3/ld/data/Painter_root/ade20k_semantic/attack_analysis/{args.attack_method}_{args.num_steps}/{args.attack_id}_{args.epsilon}/'
