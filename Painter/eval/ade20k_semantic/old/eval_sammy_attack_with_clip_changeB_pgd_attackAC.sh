...
# inference
CUDA_VISIBLE_DEVICES=3,4,5,6 python -m torch.distributed.launch --nproc_per_node=${NUM_GPUS} --master_port=1989 --use_env \
...
# bash eval/ade20k_semantic/eval_sammy_attack_with_clip_changeB_pgd_attackAC.sh