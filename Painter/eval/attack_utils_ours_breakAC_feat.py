...
def construct_adv_C_pgd_breakAC_feat(img, tgt, model, device, epsilon, num_steps, step_size, rand_init='rand'):
...
def get_adv_img_adv_tgt_breakAC_feat(img, tgt, model_painter, device, attack_id, attack_method, epsilon, num_steps):
    if attack_id == 'attack_A':
        ...
        if attack_method == 'FGSM':
            ...
            adv_img, adv_tgt = construct_adv_C_pgd_breakAC_feat(img, tgt, model_painter, device, epsilon=epsilon/255., num_steps=num_steps, step_size=2/255, rand_init='rand')
